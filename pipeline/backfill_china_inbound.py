...
FTITLE = r'(总统|总理|首相|国王|女王|国家元首|埃米尔|苏丹|大公|亲王|委员长|临时总统|总统当选人|内阁总理|联邦总理|国务委员会主席兼部长会议主席|国务委员会主席|国家主席|联邦主席|主席)'
EXCL = r'外长|外交大臣|副总理|副总统|王储|国家杜马|国际奥委会|议长|前总统|前总理|夫人|特使|特别代表|国会主席|大呼拉尔|参议院|众议院|国民议会|人民院|联邦院|基金会|副首相|第一副主席|副主席|世界经济论坛|国际商会|非盟|联邦委员会|国际篮联|红十字|参联会|荣誉主席|联合国|非洲联盟|国民党|参谋长联席会议|国家安全事务助理|祖国阵线|桑给巴尔|友协'
CN_PLACES = ['北京','人民大会堂','钓鱼台','中南海','天津','上海','杭州','成都','广州','深圳','西安','哈尔滨','三亚','博鳌','厦门','青岛','郑州','南京','武汉','重庆','南海']
PAT1 = re.compile(r'(?:会见|同|与)([一-龥]{2,12}?)(总统|总理|国王|女王|首相|国家元首|埃米尔|苏丹|大公|亲王|委员长|临时总统|总统当选人|内阁总理|联邦总理|国务委员会主席兼部长会议主席|国务委员会主席|国家主席|联邦主席|主席)([一-龥·]{1,15})')

CN_FIX = {'越共': '越南', '越共中央总': '越南', '老挝人民革': '老挝', '朝鲜劳动党': '朝鲜'}  # PAT2 贪婪时代残留与缩写
...
def extract(years=None):
    ...
    for fn in sorted(os.listdir(ART)):
        ...
        d, t, body = p
        n_all += 1
        if d < '2013-01-01': continue  # 数据集口径 2013 起
    ...
    for r in sorted(recs, key=lambda x: x['date']):
        ...
        country = CN_FIX.get(country, country)
...
PAT_A = re.compile(r'^([一-龥]{2,15}?)(总统|总理|首相|国王|女王|国家元首|埃米尔|苏丹|大公|亲王|委员长|内阁总理|联邦总理|国务委员会主席兼部长会议主席|国务委员会主席|国家主席|联邦主席|主席)([一-龥·\-]{1,15}?)将')
