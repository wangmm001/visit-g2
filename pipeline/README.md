...
## 已知事项
1. 访华 2013-2024 回填已完成 78% (638/819, 2026-07 v2 三通道: Wayback正文+预告文章+峰会名单, 详见 docs/backfill_report_202607.md; 含 2026-07-12 HOGS 口径净化: 删 16 行组织实体/副职/议长误采)。重跑: python3 backfill_china_inbound.py all (约6h, 断点续传)。剩余缺口: 2013-15 早期快照稀疏为主 (出路: MFA /eng/ 或 gov.cn/xinwen 定向窗口)。
