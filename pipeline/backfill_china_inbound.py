...
PAT1 = re.compile(r'(?:会见|同|与)([一-龥]{2,12}?)(总统|总理|国王|首相|国家元首|埃米尔|苏丹|大公|亲王|委员长|临时总统|总统当选人|内阁总理|联邦总理|国家主席|联邦主席|主席)([一-龥·]{1,15})')
...
PAT_A = re.compile(r'^([一-龥]{2,15}?)(总统|总理|首相|国王|国家元首|埃米尔|苏丹|大公|亲王|委员长|内阁总理|联邦总理|国家主席|联邦主席|主席)([一-龥·\-]{1,15}?)将')
